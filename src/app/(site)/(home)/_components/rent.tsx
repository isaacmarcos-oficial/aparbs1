...
export default function Rent() {
  return (
    <section aria-labelledby="rent-title" className="flex w-full items-center justify-center bg-black">
      ...
      >
        <div className="">
          <Image
            ...
            className="w-screen object-cover max-h-64 md:max-h-96 lg:max-h-[600px] hover:opacity-80 transition-all duration-300"
            width={1800}
            height={600}
            quality={80}
          />
